...
{{% teacher %}}
Ruby on Rails（ルビーオンレイルズ）は知っていますか？
{{% /teacher %}}
{{% student %}}
もちろん。一応これまでRubyを勉強してきたので、聞いたことあります。あれでしょ？レールズでしょ？レールズ。
{{% /student %}}
{{% teacher face="shock" %}}
...
{{% /student %}}
{{% teacher %}}
はい、成功です。localhostというのは自分のMacのことです。HTTPプロトコルとポート番号についてはもう習いましたよね？
